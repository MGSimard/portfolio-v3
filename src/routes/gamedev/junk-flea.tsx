          ...
          <div className="grid-1-2x">
            ...
            <div className="p-page-meta">
              ...
              <p>
                ...
                Halo Infinite's Forge tool over the course of over 400 hours shortly after the tool's release. The
                process for this level was slightly different, rather than "eyeballing" it off of Youtube videos, I
                resorted to seeking out shady tools to rip the original map files out of Combat Arms. Once the original
                map files were acquired, I brought them into Blender to use as reference for measurements and
              ...
              <p>
                ...
                player's scoring on kill to change their weapon according to the corresponding index within a weapon
                list. The scripting is included within the last section of this article.
              </p>
            </div>
          </div>
        </section>
        <section>
          ...
          <div>
            ...
            <p>
              ...
              Quarantine (Infection) however due to a lack of specific nodes within Forge's script system, I had decided
              to put the night version on hold.
            </p>
            <p>
              ...
              opponents with your intended weapon and lose a level through being melee'd or self-inflicted death. Ammo
              can be replenished by killing an opponent with melee. The script system allows anyone to modify their own
              version in Forge simply by modifying the weapon list. Since the script is fully data-driven, score and all
              other settings automatically adjust to fit. Once a player cycles through all available weapons, they win
              the round.
            </p>
          </div>
        </section>
